...
function detailAccountApi(app, express) {
    ...
    apiRouter.route('/dimensions/category/:categoryId')
    ...
    apiRouter.route('/dimensions/:id/activate')
        .put(function (req, res) {
            var dimension = Enumerable.from(dimensionCategories)
                .selectMany(function (cat) {
                    return cat.dimensions
    ...
    apiRouter.route('/dimensions/:id/deactivate')
        .put(function (req, res) {
            var dimension = Enumerable.from(dimensionCategories)
                .selectMany(function (cat) {
                    return cat.dimensions
